...
#include "KLTbase.h"
#include "KLTerror.h"
#include "KLTconvolve.h"	/* for computing pyramid */
#include "KLTklt.h"
#include "KLTklt_util.h"	/* _KLT_FloatImage */
#include "KLTpyramid.h"	/* _KLT_Pyramid */
  ...
  int height)
{
  ...
  char *tmp = new char[width*height*sizeof(float)];
  fw = (_FloatWindow) tmp; // malloc(width*height*sizeof(float));
